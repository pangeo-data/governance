...
[*TODO*](mailto:TODO) or by filling out [this
form](TODO). For more details please see our
...
members, in all spaces managed by Pangeo. This includes the mailing lists,
...
7. **When we disagree, try to understand why**. Disagreements, both social and
   technical, happen all the time and Pangeo is no exception.  Try to
...
Original text courtesy of the [*Jupyter*](http://jupyter.org/conduct/) Project,
modified by Pangeo.  We are grateful to those projects for contributing these
